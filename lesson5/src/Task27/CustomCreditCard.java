...
public class CustomCreditCard extends CreditCard {
    private String cardholderName;
    private final String CURRENCY = "BYN";
    private int moneyInAccount;

    public CustomCreditCard(long cardNumber, int cvv, Date validity, String paymentSystem, int creditSum, String cardholderName) {
        super(cardNumber, cvv, validity, paymentSystem, creditSum);
        this.cardholderName = cardholderName;
        this.moneyInAccount = creditSum;
    }
